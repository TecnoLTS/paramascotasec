...
export default async function FilterCanvasProductOne({ searchParams }: { searchParams?: Promise<SearchParams> }) {
    ...
    if (error) {
        ...
        content = <ShopFilterCanvas data={products} productPerPage={12} dataType={type} productStyle="style-1" />
    }
