...
export default async function FilterCanvasProductFour({ searchParams }: { searchParams?: Promise<SearchParams> }) {
    ...
    if (error) {
        ...
        content = <ShopFilterCanvas data={products} productPerPage={12} dataType={type} productStyle="style-4" />
    }
