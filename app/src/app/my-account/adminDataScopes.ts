...
export const ADMIN_TABS_WITH_VAT_SETTINGS = new Set([
  'reports',
  'prices',
  'taxes',
  'margins',
...
export const ADMIN_TABS_WITH_SHIPPING_SETTINGS = new Set([
  'reports',
  'prices',
  'taxes',
  'calculations',
...
export const ADMIN_TABS_WITH_PRODUCTS = new Set(['products', 'inventory', 'prices', 'local-sales', 'quotations', 'expenses', 'reports', 'sales-ranking'])
