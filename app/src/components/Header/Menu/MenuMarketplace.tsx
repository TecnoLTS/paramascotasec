                    ...
                    <div className="container mx-auto h-full">
                        <div className="header-main flex items-center justify-between h-full">
                            ...
                            <Link href={'/'} className='flex items-center'>
                                <div className="heading4 text-white">ParaMascotasEC</div>
                            </Link>
                            ...
                            <div className="right flex gap-12">
                                <div className="list-action flex items-center gap-4">
                                    ...
                                    <div className="cart-icon flex items-center relative cursor-pointer" onClick={openModalCart}>
                                        ...
                                        <span className="quantity cart-quantity absolute -right-1.5 -top-1.5 text-xs text-white bg-red w-4 h-4 flex items-center justify-center rounded-full">{cartState.cartArray.reduce((sum, item) => sum + (item.quantity ?? 0), 0)}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            ...
                            <div className="form-search relative mt-2">
                                ...
                                <input placeholder='¿Qué estás buscando?' className=' h-12 rounded-lg border border-line text-sm w-full pl-10 pr-4' />
                            </div>
                            <div className="list-nav mt-6">
                                <ul>
                                    ...
                                    >
                                        <Link href={'#!'} className={`text-xl font-semibold flex items-center justify-between`}>Demostraciones
                                    ...
                                    >
                                        <Link href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Características
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </Link>
                                            ...
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                                ...
                                                <div className="banner-ads-block grid sm:grid-cols-2 items-center gap-6 pt-6">
                                                    <div className="banner-ads-item bg-linear rounded-2xl relative overflow-hidden" onClick={() => handleCategoryClick('organic')}>
                                                        <div className="text-content py-14 pl-8 relative z-[1]">
                                                            <div className="text-button-uppercase text-white bg-red px-2 py-0.5 inline-block rounded-sm">Ahorra $10</div>
                                                            <div className="heading6 mt-2">20% de descuento <br />orgainc</div>
                                                            <div className="body1 mt-3 text-secondary">
                                                                Desde <span className='text-red'>$59.99</span>
                                                            </div>
                                                            <div className="button-main mt-5">Comprar ahora</div>
                                    ...
                                    >
                                        <Link href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Tienda
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </Link>
                                    ...
                                    >
                                        <Link href={'#!'} className='text-xl font-semibold flex items-center justify-between mt-5'>Páginas
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </Link>
