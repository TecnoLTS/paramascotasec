...
const tenants: Record<TenantId, TenantConfig> = {
  paramascotasec: {
    ...
    menu: {
      ...
      departmentLinks: [
        { label: 'Comida para perros', href: '/shop/breadcrumb1?category=perros&gender=dog' },
        { label: 'Comida para gatos', href: '/shop/breadcrumb1?category=gatos&gender=cat' },
        { label: 'Servicios para mascotas', href: '/pages/contact' },
      ],
    },
    footerCategoryLinks: ['todos', 'descuentos', 'perros', 'gatos'],
  },
  autorepuestoscore: {
